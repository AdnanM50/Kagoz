...
export default function SpecialFeaturesPage() {
  const [formData, setFormData] = useState<SpecialFeaturesData>({
    promoVideoUrl: '',
    customerLogos: [],
    customerFeedback: {
      name: '',
  ...
  const handleCustomerLogosChange = (files: UploadedFile[]) => {
    setFormData(prev => ({ ...prev, customerLogos: files }))
  }

  const handleCustomerImageChange = (files: UploadedFile[]) => {
    setFormData(prev => ({ 
      ...prev, 
      customerFeedback: { ...prev.customerFeedback, customerImage: files }
    }))
  }

  const handleFeaturedOffersChange = (files: UploadedFile[]) => {
    setFormData(prev => ({ ...prev, featuredOffers: files }))
  }

  const handleInputChange = (field: keyof typeof formData.customerFeedback, value: string) => {
    setFormData(prev => ({
      ...prev,
      customerFeedback: { ...prev.customerFeedback, [field]: value }
    }))
  }
  ...
  const handleRatingChange = (rating: number) => {
    setFormData(prev => ({
      ...prev,
      customerFeedback: { ...prev.customerFeedback, rating }
    }))
  }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Submitting Special Features Data:', formData)
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="">
                ...
                placeholderIcon={User}
                  ...
                  value={formData.customerFeedback.name}
            ...
            <div>
              ...
              <div className="">
                ...
                placeholderIcon={Building}
                  ...
                  value={formData.customerFeedback.company}
            ...
            <div>
              ...
              <div className="">
                ...
                placeholderIcon={Youtube}
                  placeholder="Paste Youtube link"
                  value={formData.customerFeedback.youtubeUrl}
